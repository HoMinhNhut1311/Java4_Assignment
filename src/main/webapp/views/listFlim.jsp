...
List<Movie> listM = DataCache.getListM();
  for (Movie m : listM) {
%>
<a href="${pageContext.request.contextPath}/movie/detail?id=<%= m.getId() %>" class="nft" style="text-decoration: none">
  <div class='main'>
    <img class='tokenImage' src="<%= m.getSrcImg() %>" alt="NFT"/>
    <h2 class="fs-5" style="color: red"><%= m.getTitle() %></h2>
    <div  style="height: 160px;overflow: hidden;">
    	<p class='description' style="font-size: 10px"><%= m.getDes()%></p>
    </div>
    <div class='tokenInfo'>
      <div class="price">
      ...
      <div class="duration">
        <span class="text-primary">◷<%= m.getDuration() %> phút</span>
      </div>
      <div class="view">
        <span class="text-danger">
        <i class="fas fa-eye"></i>
        <%= m.getVisit() %> Lượt xem</span>
      </div>
    </div>
    <hr />
    <div class='creator' style="display: flex;justify-content: space-between;"> 
